...
Config.Version = "VORP" -- "Standalone" = Only the command is used to attach or remove the scope / "VORP" = All features in the config file can be used with VORP (features such as attaching a scope with an item)
